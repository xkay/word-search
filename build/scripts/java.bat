...
set CLASSPATH=%APP_HOME%\lib\java-1.0.jar;%APP_HOME%\lib\minimal-json-0.9.4.jar

@rem Execute java
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAVA_OPTS%  -classpath "%CLASSPATH%" TestAnswer %CMD_LINE_ARGS%
